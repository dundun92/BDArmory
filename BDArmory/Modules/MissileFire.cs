...
namespace BDArmory.Modules
{
    public class MissileFire : PartModule
    {
       ...
       UI_FloatRange(minValue = 0f, maxValue = 5f, stepIncrement = 0.05f, scene = UI_Scene.All)]
        ...
        [KSPField(isPersistant = true, guiActive = false, guiActiveEditor = false, guiName = "Chaff Burst Size"),
       UI_FloatRange(minValue = 0f, maxValue = 20f, stepIncrement = 1f, scene = UI_Scene.All)]
        public float chaffSize = 1f;

        [KSPField(isPersistant = true, guiActive = false, guiActiveEditor = false, guiName = "Flare Burst Size"),
       UI_FloatRange(minValue = 0f, maxValue = 20f, stepIncrement = 0.05f, scene = UI_Scene.All)]
