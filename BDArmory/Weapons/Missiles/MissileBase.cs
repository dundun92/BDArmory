...
namespace BDArmory.Weapons.Missiles
{
    public abstract class MissileBase : EngageableWeapon, IBDWeapon
    {
        ...
        [KSPField(isPersistant = true, guiActive = true, guiActiveEditor = true, guiName = "Clamped DLZ"), // if true, DLZ is clamped as per "old" behavior
            UI_Toggle(disabledText = "#LOC_BDArmory_UnclampTuning_enabledText", enabledText = "#LOC_BDArmory_UnclampTuning_disabledText", scene = UI_Scene.All, affectSymCounterparts = UI_Scene.All)]
        public bool clampedDLZ = true;
